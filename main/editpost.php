...
global $categories, $forums, $fid, $user_group, $post_group, $postcodefield, $error, $smileys, $emoticons, $popup_emoticons, $tid, $board, $post_title, $post, $i_started, $attachments, $tree, $preview;
	...
	$postcode = (isset($AEF_SESS['er'.$pid.'postcode']) ? $AEF_SESS['er'.$pid.'postcode'] : '');
	
	//Now create a new one
	$AEF_SESS['er'.$pid.'postcode'] = generateRandStr(16);
	
	$postcodefield = '<input type="hidden" value="'.$AEF_SESS['er'.$pid.'postcode'].'" name="postcode" />';
