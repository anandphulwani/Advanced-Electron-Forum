...
global $smileys, $emoticons, $popup_emoticons, $postcodefield, $error, $reply, $pmto, $tree;
	...
	$postcode = (isset($AEF_SESS['npmpostcode']) ? $AEF_SESS['npmpostcode'] : '');
	
	//Now create a new one
	$AEF_SESS['npmpostcode'] = generateRandStr(16);
	
	$postcodefield = '<input type="hidden" value="'.$AEF_SESS['npmpostcode'].'" name="postcode" />';
