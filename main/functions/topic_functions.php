...
global $user, $conn, $dbtables, $logged_in, $globals, $l, $AEF_SESS, $theme, $error;
	...
	if($globals['maxtitlechars'] && (strlen($title) > $globals['maxtitlechars'])){
	...
	if($globals['mintitlechars'] && (strlen($title) < $globals['mintitlechars'])){
...
global $user, $conn, $dbtables, $logged_in, $globals, $l, $AEF_SESS, $theme, $error;
	...
	//Check the Max Length
	if($globals['maxdescchars'] && (strlen($description) > $globals['maxdescchars'])){
	...
	//Check the Min Length
	if($globals['mindescchars'] && (strlen($description) < $globals['mindescchars'])){
...
global $user, $conn, $dbtables, $logged_in, $globals, $l, $AEF_SESS, $theme, $error, $smileys;	
	...
	if($globals['maxcharposts'] && (strlen($post) > $globals['maxcharposts'])){
	...
	if($globals['mincharposts'] && (strlen($post) < $globals['mincharposts'])){
