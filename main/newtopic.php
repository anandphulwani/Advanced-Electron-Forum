...
global $categories, $forums, $fid, $postcodefield, $error, $smileys, $emoticons, $popup_emoticons, $tid, $board, $tree, $preview;
	...
	$postcode = (isset($AEF_SESS['nt'.$fid.'postcode']) ? $AEF_SESS['nt'.$fid.'postcode'] : '');
	
	//Now create a new one
	$AEF_SESS['nt'.$fid.'postcode'] = generateRandStr(16);
	
	$postcodefield = '<input type="hidden" value="'.$AEF_SESS['nt'.$fid.'postcode'].'" name="postcode" />';
