...
global $categories, $forums, $board, $samelevel, $member_group, $mother_options, $currentmother, $order_of_boards, $error, $user_group, $themes, $children, $postcodefield;
	...
	$postcode = (isset($AEF_SESS['nfpostcode']) ? $AEF_SESS['nfpostcode'] : '');
	
	//Now create a new one
	$AEF_SESS['nfpostcode'] = generateRandStr(16);
	
	$postcodefield = '<input type="hidden" value="'.$AEF_SESS['nfpostcode'].'" name="postcode" />';
