...
<form action=""  method="get" name="account_actform">
...
<form action=""  method="post" name="reg_ageform">
...
<form action=""  method="post" name="coppaform">
...
<form action=""  method="post" name="resendactform">
<table width="70%" cellpadding="2" cellspacing="1" class="cbor" align="center">
