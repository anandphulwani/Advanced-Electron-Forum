...
<td class="bbc" width="22" onmouseover="this.className='bbcon'" onmouseout="this.className='bbc'"><a onclick="javascript:<?php echo $object;?>.wrap_bbc('[flash]', '[/flash]');" href="javascript:void(0);" title="Flash"><img src="<?php echo $theme['images'];?>bbc/flash.gif" alt="Flash" /></a></td>
